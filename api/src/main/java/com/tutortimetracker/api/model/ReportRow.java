...
public record ReportRow(
        ...
        String projectId,
        @Schema(description = "Reporting month", example = "2026-03")
        String month,
        @Schema(description = "Project display name", example = "Math Grade 10")
        String projectName,
        @Schema(description = "Total tracked hours in month", example = "12.5")
        double totalHours,
        @Schema(description = "Session count in month", example = "8")
        int sessions,
