...
public record ProjectCalendarResponse(
    ...
    @Schema(description = "Timeslots scheduled for the current day") List<TodaySlot> todaySlots,
    @Schema(description = "Timeslots in the requested month") List<CalendarSlot> monthSlots,
    @Schema(description = "All project timeslots across months") List<CalendarSlot> allSlots) {}
