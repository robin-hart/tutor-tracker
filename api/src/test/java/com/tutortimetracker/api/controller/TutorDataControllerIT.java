...
class TutorDataControllerIT {
    ...
    void deleteProject_shouldRemoveProjectAndAssociatedData() throws Exception {
        ...
        mockMvc.perform(delete("/api/projects/{projectId}", project.getSlug()))
    ...
    void deleteProject_shouldReturnNotFoundForMissingProject() throws Exception {
        mockMvc.perform(delete("/api/projects/missing-project"))
    ...
    void updateStudentNotes_shouldReturnNotFoundForMissingStudent() throws Exception {
        ...
        mockMvc.perform(patch("/api/students/{studentId}/notes", "missing-student")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(payload)))
                .andExpect(status().isNotFound());
    }
    ...
    void deleteStudent_shouldReturnNotFoundForMissingStudent() throws Exception {
        mockMvc.perform(delete("/api/students/missing-student"))
                .andExpect(status().isNotFound());
    }
    ...
    void getProjectGroups_shouldReturnGroupsWithCounts() throws Exception {
        ...
        mockMvc.perform(get("/api/projects/{projectId}/groups", project.getSlug()))
                .andExpect(status().isOk())
    ...
    void createProjectGroup_shouldCreateNewGroup() throws Exception {
        ...
        mockMvc.perform(post("/api/projects/{projectId}/groups", project.getSlug())
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(payload)))
                .andExpect(status().isCreated())
    ...
    void createProjectGroup_shouldReturnNotFoundForMissingProject() throws Exception {
        ...
        mockMvc.perform(post("/api/projects/{projectId}/groups", "missing-project")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(payload)))
                .andExpect(status().isNotFound());
    }
    ...
    void deleteProjectGroup_shouldReassignStudents() throws Exception {
        ...
        mockMvc.perform(delete("/api/projects/{projectId}/groups/{groupName}", project.getSlug(), "ToDelete"))
                .andExpect(status().isNoContent());
    ...
    void deleteProjectGroup_shouldRejectDeletingUngrouped() throws Exception {
        ...
        mockMvc.perform(delete("/api/projects/{projectId}/groups/{groupName}", project.getSlug(), "Ungrouped"))
                .andExpect(status().isBadRequest())
    ...
    void updateStudentGroup_shouldChangeGroupAssignment() throws Exception {
        ...
        mockMvc.perform(patch("/api/students/{studentId}/group", student.getStudentKey())
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(payload)))
                .andExpect(status().isOk())
    ...
    void updateStudentGroup_shouldReturnNotFoundForMissingStudent() throws Exception {
        ...
        mockMvc.perform(patch("/api/students/{studentId}/group", "missing-student")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(payload)))
                .andExpect(status().isNotFound());
    }
    ...
    void getProjectCalendar_shouldReturnCalendarData() throws Exception {
        ...
        mockMvc.perform(get("/api/projects/{projectId}/calendar", project.getSlug()))
                .andExpect(status().isOk())
    ...
    void getProjectCalendar_shouldReturnNotFoundForMissingProject() throws Exception {
        mockMvc.perform(get("/api/projects/{projectId}/calendar", "missing-project"))
                .andExpect(status().isNotFound());
    }
    ...
    void createProjectTimeslot_shouldCreateTimeslot() throws Exception {
        ...
        mockMvc.perform(post("/api/projects/{projectId}/timeslots", project.getSlug())
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(payload)))
                .andExpect(status().isCreated())
    ...
    void createProjectTimeslot_shouldReturnNotFoundForMissingProject() throws Exception {
        ...
        mockMvc.perform(post("/api/projects/{projectId}/timeslots", "missing-project")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(payload)))
                .andExpect(status().isNotFound());
    }
    ...
    void getProjectTimeslots_shouldReturnTimeslotsInMonth() throws Exception {
        ...
        mockMvc.perform(get("/api/projects/{projectId}/timeslots", project.getSlug())
                        .param("month", "2026-01"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.length()").value(2));
    }
    ...
    void getProjectTimeslot_shouldReturnSingleTimeslot() throws Exception {
        ...
        mockMvc.perform(get("/api/projects/{projectId}/timeslots/{timeslotId}", project.getSlug(), slot.getId()))
                .andExpect(status().isOk())
    ...
    void getProjectTimeslot_shouldReturnNotFoundForMissingSlot() throws Exception {
        ...
        mockMvc.perform(get("/api/projects/{projectId}/timeslots/{timeslotId}", project.getSlug(), "missing"))
                .andExpect(status().isNotFound());
    }
    ...
    void updateProjectTimeslot_shouldUpdateTimeslot() throws Exception {
        ...
        mockMvc.perform(put("/api/projects/{projectId}/timeslots/{timeslotId}", project.getSlug(), slot.getId())
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(payload)))
                .andExpect(status().isOk())
    ...
    void deleteProjectTimeslot_shouldRemoveTimeslot() throws Exception {
        ...
        mockMvc.perform(delete("/api/projects/{projectId}/timeslots/{timeslotId}", project.getSlug(), slot.getId()))
                .andExpect(status().isNoContent());
    ...
    void getReports_shouldReturnAllReports() throws Exception {
        ...
        mockMvc.perform(post("/api/projects/{projectId}/reports/generate", project.getSlug())
                        .param("month", "2026-01"))
                .andExpect(status().isOk());
    ...
    void getProjectReports_shouldReturnProjectOnlyReports() throws Exception {
        ...
        mockMvc.perform(post("/api/projects/{projectId}/reports/generate", project1.getSlug())
                        .param("month", "2026-01"));
        mockMvc.perform(post("/api/projects/{projectId}/reports/generate", project2.getSlug())
                        .param("month", "2026-01"));

        mockMvc.perform(get("/api/projects/{projectId}/reports", project1.getSlug()))
                .andExpect(status().isOk())
    ...
    void generateProjectReport_shouldReturnNotFoundForMissingProject() throws Exception {
        mockMvc.perform(post("/api/projects/{projectId}/reports/generate", "missing-project")
                        .param("month", "2026-01"))
                .andExpect(status().isNotFound());
    }
    ...
    void createTimeslot_shouldCreateGlobalTimeslot() throws Exception {
        ...
        projectRepository.findBySlug("math-grade-10")
    ...
    private TimeslotEntity createTimeslot(ProjectEntity project, String title, LocalDate date, int durationMinutes) {
